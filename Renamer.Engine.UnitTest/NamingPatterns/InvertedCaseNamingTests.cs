...
{
    [TestClass]
    public class InvertedCaseNamingTests
    {
        ...
        public async Task Execute_WithFileExtension()
        {
            ...
            var renameSettings = RenameSettingsFactory.InvertedCase(true);

            // act
            var naming = new InvertedCaseNaming(renamer, renameSettings);
        ...
        public async Task Execute_WithoutFileExtension()
        {
            ...
            var renamer = Substitute.For<IRenamer>();
            renamer.Rename(default, default, default).ReturnsForAnyArgs(Task.FromResult<bool>(true));
            var renameSettings = RenameSettingsFactory.InvertedCase(false);
