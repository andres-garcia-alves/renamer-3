...
{
    [TestClass]
    public class TitleCaseNamingTests
    {
        ...
        public async Task Execute_WithFileExtension()
        {
            ...
            var renameSettings = RenameSettingsFactory.TitleCase(true);

            // act
            var naming = new TitleCaseNaming(renamer, renameSettings);
        ...
        public async Task Execute_WithoutFileExtension()
        {
            ...
            var renamer = Substitute.For<IRenamer>();
            renamer.Rename(default, default, default).ReturnsForAnyArgs(Task.FromResult<bool>(true));
            var renameSettings = RenameSettingsFactory.TitleCase(false);
